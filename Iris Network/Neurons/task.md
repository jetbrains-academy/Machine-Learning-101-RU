...
англ. feedforward neural network), где все связи направлены строго от входных нейронов к выходным.</p>
...
<h2>Задание</h2>
В файле <code>activation.py</code> реализуйте логистическую функцию активации <code>sigmoid()</code>, пользуясь формулой, приведенной в объяснении теории.
