...
В файле `utils.py` находится функция `train_test_split`, разбивающая заданную выборку на обучающую и контрольную. Также там находится функция `plot_classification`, которая 
