...
Алгоритм будет сравнивать данные из диагнозов и настраивать вектор весов так, чтобы как можно большее количество имеющих или не имеющих заболевание было правильно угадано с каждым шагом.
...
В файле `precision_recall` находятся [функции для вычисления точности и полноты](course://neighbours_and_wine/precision_and_recall). Их можно использовать для оценки качества классификации. 
