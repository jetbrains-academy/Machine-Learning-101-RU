...
def train_test_split(X, y, ratio=0.8):
    ...
    # A slice with first train_len elements of X would be
    # the training sample for objects
    X_train
    # A slice with the rest of X would be
    # the testing sample for objects
    X_test
    # A slice with first train_len of y would be
    # the training sample for classes
    y_train
    # A slice with the rest of y would be
...
if __name__ == '__main__':
    ...
    # the corresponding class will have the same index
