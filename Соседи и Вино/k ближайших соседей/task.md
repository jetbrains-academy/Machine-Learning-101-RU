...
При выборе метрики стоит стремиться к максимизации суммы расстояний между объектами разных классов и минимизации расстояний между объектами одного класса. При достижении этого разные классы будут лежать далеко друг от друга, а схожие - рядом.
