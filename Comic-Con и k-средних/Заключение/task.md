Скорость работы данного алгоритма весьма сильно зависит от количества кластеров. Попробуйте запустить программу для 4 или 16 цветов и увидите, насколько меняется время выполнения. 
