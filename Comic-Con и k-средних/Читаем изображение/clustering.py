...
def k_means(X, n_clusters, distance_metric):
    ...
    # so the number of provided samples is equal to one matrix dimension,
    ...
    while True:
        # We enumerate the clusters and calculate distances to them
        ...
        for i in range(n_clusters):
            ...
            # Here we also check if an empty cluster
            # without any corresponding samples appears
